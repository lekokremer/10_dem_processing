...
When writing scripts, developers typically follow a standard workflow were certains steps are performed together:<br>
1. Import required libraries <br>
2. Generate functions useful for the script <br>
...
While you might find slight variations among collaborators, following this general workflow ensures that our scripts are structured in a way that facilitates easy sharing and reproducibility of results. For example, if you decide that you need package when working on your analysis 500 lines into the script, add the library() code to the beginning of your script, not to the chunk where you are using it. <br>
